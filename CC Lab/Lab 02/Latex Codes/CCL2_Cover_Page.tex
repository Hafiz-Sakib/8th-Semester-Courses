...
\begin{titlepage}
    ...
    \Large \textnormal{Lab Report 02:  A program to identify whether a given line is a comment or not and generate a commentfree C program }
    ...
    \begin{tabular}{|p{0.4\textwidth}|p{0.6\textwidth}|} % Set column widths to 40% and 60%
        ...
        \textbf{Section} & C \\
        \hline
        \textbf{Session} & Fall 2025 \\
        \hline
        \textbf{Semester} & 8th Semester \\
        \hline
        \textbf{Submission Date} & 31.01.2026 \\
        \hline
    \end{tabular}
    \vspace{1cm}
