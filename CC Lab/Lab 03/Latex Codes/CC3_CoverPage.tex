...
\begin{titlepage}
    \centering
    \includegraphics[width=0.3\textwidth]{logo.png} % Adjust width as necessary
    \vspace{1cm}
    ...
    \Large \textnormal{Lab Report 03:  Write a program to identify instances of unique keywords from a C program}
    ...
    \begin{tabular}{|p{0.4\textwidth}|p{0.6\textwidth}|} % Set column widths to 40% and 60%
        ...
        \hline
        \textbf{Date of performance} & 31.01.2026  \\
        \hline
        \textbf{Submission Date} & 03.02.2026 \\
        \hline
    \end{tabular}
    \vspace{1cm}
