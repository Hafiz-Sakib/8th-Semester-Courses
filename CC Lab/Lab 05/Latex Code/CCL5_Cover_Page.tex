...
\begin{titlepage}
    \centering
    \includegraphics[width=0.3\textwidth]{logo.jpg} % Adjust width as necessary
    \vspace{1cm}
    ...
    \huge \textnormal{CSE 454: Compiler Construction Laboratory}
    \vspace{1in} % Adjusts vertical space after the course title

    \Large \textnormal{Lab Report 05:  Write a program to identify unique identifiers from a C program using a basic lexical analyzer.}
    ...
    \begin{tabular}{|p{0.4\textwidth}|p{0.6\textwidth}|} % Set column widths to 40% and 60%
        ...
        \textbf{Section} & C \\
        \hline
        \textbf{Session} & Fall 2025 (8th Semester) \\
        \hline
        \textbf{Date of performance} & 14.02.2026  \\
        \hline
        \textbf{Submission Date} & 21.02.2026 \\
        \hline
    \end{tabular}
    \vspace{1cm}
