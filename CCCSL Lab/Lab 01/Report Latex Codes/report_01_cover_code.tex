...
\begin{titlepage}
    ...
    \huge \textnormal{CSE 482: Contemporary Course of Computer Science \& Laboratory}
    \vspace{1in} % Adjusts vertical space after the course title

    \Large \textnormal{Lab Report 01:  Introduction to AWS Identity and Access Management (IAM) }
